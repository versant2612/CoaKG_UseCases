...
printf "K0 "
## K0. Qual é a representação da unidade geo-política atual referente ao "nome completo"? 
## K0 -> ?v1, alias, "Nome completo". ?v1, P3896, ?v2
...
--where 'v1_alias = $name ' --para name="'Nome completo'@en" \
...
-o /app/kgtk/data/WD_PoC/qId-K0-base.tsv
...
-o /app/kgtk/data/WD_PoC/qId-p3896-K0-mandatory-context.tsv
...
--para name="'Nome completo'@en" \
--return 'p1 as id, v1 as node1, v1_label as `node1;label`, p1.label as label, p_label as `label;label`, v2 as node2, v2_label as `node2;label`, q1 as id, p1 as node1, "" as `node1;label`, c1 as label, c1_label as `label;label`, v3 as node2, v3_label as `node2;label`, pc2 as id, C as node1, C_label as `node1;label`, "ckgr1" as label, "ckg:Represented By" as `label;label`, c1 as node2, c1_label as `node2;label`' \
-o /app/kgtk/data/WD_PoC/qId-p3896-K0-suggested-context.tsv
...
-o /app/kgtk/data/WD_PoC/qId-p3896-K0-qualified.tsv
...
--where 'EXISTS {ckg: (pc1)-[pc3:ckgp1]->(ckgl2)} AND NOT EXISTS {cq: (p1)-[q1]->(v2) where q1.label = c1} AND v1_alias = $name ' --para name="'Nome completo'@en"  \
...
-o /app/kgtk/data/WD_PoC/qId-p3896-K0-unknown.tsv

printf "K1 "
## K1. Quais unidades geo-políticas / nações o atual "QId" substituiu? 
## K1a => qId, p1365, ?v1

\time --format='Elapsed time: %e seconds'  kgtk --debug reachable-nodes -i $GRAPH_CLAIMS --root qId --prop P1365 --breadth-first \
-o /app/kgtk/data/WD_PoC/qId-p1365-K1path.tsv

export GRAPH_qId_PATH=/app/kgtk/data/WD_PoC/qId-p1365-K1path.tsv

\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc \
--match 'cc: (:qId {label: c_label})-[p1:P1365]->(v1 {label: v1_label}) ' \
-o /app/kgtk/data/WD_PoC/qId-p1365-K1-base.tsv
...
--match 'cc: (:qId {label: c_label})-[p1:P1365 {`label;label`: p_label}]->(v1 {label: v1_label}), cq: (p1)-[q1]->(v2 {label: v2_label}), ckg: (C {label: C_label})-[pc2:ckgr1]->(c1 {label: c1_label})-[pc1:ckgr2]->(:P1365) ' \
--where 'q1.label = c1 AND EXISTS {ckg: (pc1)-[pc3:ckgp1]->(ckgl2)} ' \
--return 'p1 as id, "qId" as node1, c_label as `node1;label`, p1.label as label, p_label as `label;label`, v1 as node2, v1_label as `node2;label`, q1 as id, p1 as node1, "" as `node1;label`, c1 as label, c1_label as `label;label`, v2 as node2, v2_label as `node2;label`, pc2 as id, C as node1, C_label as `node1;label`, "ckgr1" as label, "ckg:Represented By" as `label;label`, c1 as node2, c1_label as `node2;label`' \
-o /app/kgtk/data/WD_PoC/qId-p1365-K1-mandatory-context.tsv

\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc -i $GRAPH_QUALS --as cq -i $GRAPH_CKG_POC --as ckg  \
--match 'cc: (:qId {label: c_label})-[p1:P1365 {`label;label`: p_label}]->(v1 {label: v1_label}), cq: (p1)-[q1]->(v2 {label: v2_label}), ckg: (C {label: C_label})-[pc2:ckgr1]->(c1 {label: c1_label})-[pc1:ckgr2]->(:P1365) ' \
--where 'q1.label = c1 AND NOT EXISTS {ckg: (pc1)-[pc3:ckgp1]->(ckgl2)} ' \
--return 'p1 as id, "qId" as node1, c_label as `node1;label`, p1.label as label, p_label as `label;label`, v1 as node2, v1_label as `node2;label`, q1 as id, p1 as node1, "" as `node1;label`, c1 as label, c1_label as `label;label`, v2 as node2, v2_label as `node2;label`, pc2 as id, C as node1, C_label as `node1;label`, "ckgr1" as label, "ckg:Represented By" as `label;label`, c1 as node2, c1_label as `node2;label`' \
-o /app/kgtk/data/WD_PoC/qId-p1365-K1-suggested-context.tsv

\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc -i $GRAPH_QUALS --as cq -i $GRAPH_CKG_POC --as ckg \
--match 'cc: (:qId {label: c_label})-[p1:P1365 {`label;label`: p_label}]->(v1 {label: v1_label}) ' \
...
--return 'p1 as id, "qId" as node1, c_label as `node1;label`, p1.label as label, p_label as `label;label`, v1 as node2, v1_label as `node2;label`, q1 as id, iif(q1 is not null, p1, "") as node1, "" as `node1;label`, q1.label as label, q_label as `label;label`, v2 as node2, v2_label as `node2;label`' \
-o /app/kgtk/data/WD_PoC/qId-p1365-K1-qualified.tsv

\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc -i $GRAPH_QUALS --as cq -i $GRAPH_CKG_POC --as ckg --force \
--match 'cc: (:qId {label: c_label})-[p1:P1365 {`label;label`: p_label}]->(v1 {label: v1_label}), ckg: (C {label: C_label})-[pc2:ckgr1]->(c1 {label: c1_label})-[pc1:ckgr2]->(:P1365) ' \
--where 'EXISTS {ckg: (pc1)-[pc3:ckgp1]->(ckgl2)} AND NOT EXISTS {cq: (p1)-[q1]->(v2) where q1.label = c1} ' \
--return 'p1 as id, "qId" as node1, c_label as `node1;label`, p1.label as label, p_label as `label;label`, v1 as node2, v1_label as `node2;label`, concat(p1,"-",c1) as id, p1 as node1, "" as `node1;label`, c1 as label, c1_label as `label;label`, "unknown" as node2, "" as `node2;label` ' \
-o /app/kgtk/data/WD_PoC/qId-p1365-K1-unknown.tsv

\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc -i $GRAPH_qId_PATH --as p -i $GRAPH_QUALS --as cq -i $GRAPH_CKG_POC --as ckg \
...
-o /app/kgtk/data/WD_PoC/qId-p1365-K1path-mandatory-context.tsv

\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc -i $GRAPH_qId_PATH --as p -i $GRAPH_QUALS --as cq -i $GRAPH_CKG_POC --as ckg \
--match 'p: ()-[]->(v1), cc: (country {label: c_label})-[p1:P1365 {`label;label`: p_label}]->(v1 {label: v1_label}), cq: (p1)-[q1]->(v2 {label: v2_label}), ckg: (C {label: C_label})-[pc2:ckgr1]->(c1 {label: c1_label})-[pc1:ckgr2]->(:P1365) ' \
--where 'q1.label = c1 AND NOT EXISTS {ckg: (pc1)-[pc3:ckgp1]->(ckgl2)} ' \
--return 'p1 as id, country as node1, c_label as `node1;label`, p1.label as label, p_label as `label;label`, v1 as node2, v1_label as `node2;label`, q1 as id, p1 as node1, "" as `node1;label`, c1 as label, c1_label as `label;label`, v2 as node2, v2_label as `node2;label`, pc2 as id, C as node1, C_label as `node1;label`, "ckgr1" as label, "ckg:Represented By" as `label;label`, c1 as node2, c1_label as `node2;label`' \
-o /app/kgtk/data/WD_PoC/qId-p1365-K1path-suggested-context.tsv
...
-o /app/kgtk/data/WD_PoC/qId-p1365-K1path-qualified.tsv

\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc -i $GRAPH_qId_PATH --as p -i $GRAPH_QUALS --as cq -i $GRAPH_CKG_POC --as ckg --force \
...
-o /app/kgtk/data/WD_PoC/qId-p1365-K1path-unknown.tsv

## K1b => ?v1, p1366, qId

\time --format='Elapsed time: %e seconds'  kgtk --debug reachable-nodes -i $GRAPH_CLAIMS --root qId --prop P1366 --breadth-first \
-o /app/kgtk/data/WD_PoC/qId-p1366-K1path.tsv

export GRAPH_qId_PATH=/app/kgtk/data/WD_PoC/qId-p1366-K1path.tsv

\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc \
--match 'cc: (:qId {label: c_label})-[p1:P1366]->(v1 {label: v1_label}) ' \
-o /app/kgtk/data/WD_PoC/qId-p1366-K1-base.tsv
...
\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc -i $GRAPH_QUALS --as cq -i $GRAPH_CKG_POC --as ckg \
--match 'cc: (:qId {label: c_label})-[p1:P1366 {`label;label`: p_label}]->(v1 {label: v1_label}), cq: (p1)-[q1]->(v2 {label: v2_label}), ckg: (C {label: C_label})-[pc2:ckgr1]->(c1 {label: c1_label})-[pc1:ckgr2]->(:P1366) ' \
--where 'q1.label = c1 AND EXISTS {ckg: (pc1)-[pc3:ckgp1]->(ckgl2)} ' \
--return 'p1 as id, "qId" as node1, c_label as `node1;label`, p1.label as label, p_label as `label;label`, v1 as node2, v1_label as `node2;label`, q1 as id, p1 as node1, "" as `node1;label`, c1 as label, c1_label as `label;label`, v2 as node2, v2_label as `node2;label`, pc2 as id, C as node1, C_label as `node1;label`, "ckgr1" as label, "ckg:Represented By" as `label;label`, c1 as node2, c1_label as `node2;label`' \
-o /app/kgtk/data/WD_PoC/qId-p1366-K1-mandatory-context.tsv

\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc -i $GRAPH_QUALS --as cq -i $GRAPH_CKG_POC --as ckg \
--match 'cc: (:qId {label: c_label})-[p1:P1366 {`label;label`: p_label}]->(v1 {label: v1_label}), cq: (p1)-[q1]->(v2 {label: v2_label}), ckg: (C {label: C_label})-[pc2:ckgr1]->(c1 {label: c1_label})-[pc1:ckgr2]->(:P1366) ' \
--where 'q1.label = c1 AND NOT EXISTS {ckg: (pc1)-[pc3:ckgp1]->(ckgl2)} ' \
--return 'p1 as id, "qId" as node1, c_label as `node1;label`, p1.label as label, p_label as `label;label`, v1 as node2, v1_label as `node2;label`, q1 as id, p1 as node1, "" as `node1;label`, c1 as label, c1_label as `label;label`, v2 as node2, v2_label as `node2;label`, pc2 as id, C as node1, C_label as `node1;label`, "ckgr1" as label, "ckg:Represented By" as `label;label`, c1 as node2, c1_label as `node2;label`' \
-o /app/kgtk/data/WD_PoC/qId-p1366-K1-suggested-context.tsv

\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc -i $GRAPH_QUALS --as cq -i $GRAPH_CKG_POC --as ckg \
--match 'cc: (:qId {label: c_label})-[p1:P1366 {`label;label`: p_label}]->(v1 {label: v1_label}) ' \
--optional 'cq: (p1)-[q1 {`label;label`: q_label}]->(v2 {label: v2_label}) ' \
--where 'NOT EXISTS {ckg: (C)-[pc2:ckgr1]->(c1)-[pc1:ckgr2]->(:P1366) where q1.label = c1} ' \
--return 'p1 as id, "qId" as node1, c_label as `node1;label`, p1.label as label, p_label as `label;label`, v1 as node2, v1_label as `node2;label`, q1 as id, iif(q1 is not null, p1, "") as node1, "" as `node1;label`, q1.label as label, q_label as `label;label`, v2 as node2, v2_label as `node2;label`' \
-o /app/kgtk/data/WD_PoC/qId-p1366-K1-qualified.tsv

\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc -i $GRAPH_QUALS --as cq -i $GRAPH_CKG_POC --as ckg --force \
--match 'cc: (:qId {label: c_label})-[p1:P1366 {`label;label`: p_label}]->(v1 {label: v1_label}), ckg: (C {label: C_label})-[pc2:ckgr1]->(c1 {label: c1_label})-[pc1:ckgr2]->(:P1366) ' \
--where 'EXISTS {ckg: (pc1)-[pc3:ckgp1]->(ckgl2)} AND NOT EXISTS {cq: (p1)-[q1]->(v2) where q1.label = c1} '  \
--return 'p1 as id, "qId" as node1, c_label as `node1;label`, p1.label as label, p_label as `label;label`, v1 as node2, v1_label as `node2;label`, concat(p1,"-",c1) as id, p1 as node1, "" as `node1;label`, c1 as label, c1_label as `label;label`, "unknown" as node2, "" as `node2;label` ' \
-o /app/kgtk/data/WD_PoC/qId-p1366-K1-unknown.tsv
...
--where 'q1.label = c1 AND EXISTS {ckg: (pc1)-[pc3:ckgp1]->(ckgl2)} ' \
--return 'p1 as id, country as node1, c_label as `node1;label`, p1.label as label, p_label as `label;label`, v1 as node2, v1_label as `node2;label`, q1 as id, p1 as node1, "" as `node1;label`, c1 as label, c1_label as `label;label`, v2 as node2, v2_label as `node2;label`, pc2 as id, C as node1, C_label as `node1;label`, "ckgr1" as label, "ckg:Represented By" as `label;label`, c1 as node2, c1_label as `node2;label`' \
-o /app/kgtk/data/WD_PoC/qId-p1366-K1path-mandatory-context.tsv

\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc -i $GRAPH_qId_PATH --as p -i $GRAPH_QUALS --as cq -i $GRAPH_CKG_POC --as ckg \
--match 'p: ()-[]->(v1), cc: (country {label: c_label})-[p1:P1366 {`label;label`: p_label}]->(v1 {label: v1_label}), cq: (p1)-[q1]->(v2 {label: v2_label}), ckg: (C {label: C_label})-[pc2:ckgr1]->(c1 {label: c1_label})-[pc1:ckgr2]->(:P1366) ' \
--where 'q1.label = c1 AND NOT EXISTS {ckg: (pc1)-[pc3:ckgp1]->(ckgl2)} ' \
--return 'p1 as id, country as node1, c_label as `node1;label`, p1.label as label, p_label as `label;label`, v1 as node2, v1_label as `node2;label`, q1 as id, p1 as node1, "" as `node1;label`, c1 as label, c1_label as `label;label`, v2 as node2, v2_label as `node2;label`, pc2 as id, C as node1, C_label as `node1;label`, "ckgr1" as label, "ckg:Represented By" as `label;label`, c1 as node2, c1_label as `node2;label`' \
-o /app/kgtk/data/WD_PoC/qId-p1366-K1path-suggested-context.tsv
...
--where 'NOT EXISTS {ckg: (C)-[pc2:ckgr1]->(c1)-[pc1:ckgr2]->(:P1366) where q1.label = c1} ' \
--return 'p1 as id, country as node1, c_label as `node1;label`, p1.label as label, p_label as `label;label`, v1 as node2, v1_label as `node2;label`, q1 as id, iif(q1 is not null, p1, "") as node1, "" as `node1;label`, q1.label as label, q_label as `label;label`, v2 as node2, v2_label as `node2;label`' \
-o /app/kgtk/data/WD_PoC/qId-p1366-K1path-qualified.tsv
...
-o /app/kgtk/data/WD_PoC/qId-p1366-K1path-unknown.tsv

kgtk cat -i /app/kgtk/data/WD_PoC/qId-p1365-K1path.tsv /app/kgtk/data/WD_PoC/qId-p1366-K1path.tsv / deduplicate -o /app/kgtk/data/WD_PoC/qId-all-K1path.tsv

export GRAPH_qId_PATH=/app/kgtk/data/WD_PoC/qId-all-K1path.tsv

printf "K2"
# K2. Quando o QId foi fundado?
## K2a => qId, p571, ?v1

\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc \
--match 'cc: (:qId {label: c_label})-[p1:P571]->(v1 {label: v1_label}) ' \
-o /app/kgtk/data/WD_PoC/qId-p571-K2-base.tsv
...
\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc -i $GRAPH_QUALS --as cq -i $GRAPH_CKG_POC --as ckg \
--match 'cc: (:qId {label: c_label})-[p1:P571 {`label;label`: p_label}]->(v1 {label: v1_label}), cq: (p1)-[q1]->(v2 {label: v2_label}), ckg: (C {label: C_label})-[pc2:ckgr1]->(c1 {label: c1_label})-[pc1:ckgr2]->(:P571) ' \
--where 'q1.label = c1 AND EXISTS {ckg: (pc1)-[pc3:ckgp1]->(ckgl2)} ' \
--return 'p1 as id, "qId" as node1, c_label as `node1;label`, p1.label as label, p_label as `label;label`, v1 as node2, v1_label as `node2;label`, q1 as id, p1 as node1, "" as `node1;label`, c1 as label, c1_label as `label;label`, v2 as node2, v2_label as `node2;label`, pc2 as id, C as node1, C_label as `node1;label`, "ckgr1" as label, "ckg:Represented By" as `label;label`, c1 as node2, c1_label as `node2;label`' \
-o /app/kgtk/data/WD_PoC/qId-p571-K2-mandatory-context.tsv

\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc -i $GRAPH_QUALS --as cq -i $GRAPH_CKG_POC --as ckg \
--match 'cc: (:qId {label: c_label})-[p1:P571 {`label;label`: p_label}]->(v1 {label: v1_label}), cq: (p1)-[q1]->(v2 {label: v2_label}), ckg: (C {label: C_label})-[pc2:ckgr1]->(c1 {label: c1_label})-[pc1:ckgr2]->(:P571) ' \
--where 'q1.label = c1 AND NOT EXISTS {ckg: (pc1)-[pc3:ckgp1]->(ckgl2)} ' \
--return 'p1 as id, "qId" as node1, c_label as `node1;label`, p1.label as label, p_label as `label;label`, v1 as node2, v1_label as `node2;label`, q1 as id, p1 as node1, "" as `node1;label`, c1 as label, c1_label as `label;label`, v2 as node2, v2_label as `node2;label`, pc2 as id, C as node1, C_label as `node1;label`, "ckgr1" as label, "ckg:Represented By" as `label;label`, c1 as node2, c1_label as `node2;label`' \
-o /app/kgtk/data/WD_PoC/qId-p571-K2-suggested-context.tsv

\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc -i $GRAPH_QUALS --as cq -i $GRAPH_CKG_POC --as ckg \
--match 'cc: (:qId {label: c_label})-[p1:P571 {`label;label`: p_label}]->(v1 {label: v1_label}) ' \
--optional 'cq: (p1)-[q1 {`label;label`: q_label}]->(v2 {label: v2_label}) ' \
--where 'NOT EXISTS {ckg: (C)-[pc2:ckgr1]->(c1)-[pc1:ckgr2]->(:P571) where q1.label = c1} ' \
--return 'p1 as id, "qId" as node1, c_label as `node1;label`, p1.label as label, p_label as `label;label`, v1 as node2, v1_label as `node2;label`, q1 as id, iif(q1 is not null, p1, "") as node1, "" as `node1;label`, q1.label as label, q_label as `label;label`, v2 as node2, v2_label as `node2;label`' \
-o /app/kgtk/data/WD_PoC/qId-p571-K2-qualified.tsv

\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc -i $GRAPH_QUALS --as cq -i $GRAPH_CKG_POC --as ckg --force \
--match 'cc: (:qId {label: c_label})-[p1:P571 {`label;label`: p_label}]->(v1 {label: v1_label}), ckg: (C {label: C_label})-[pc2:ckgr1]->(c1 {label: c1_label})-[pc1:ckgr2]->(:P571) ' \
--where 'EXISTS {ckg: (pc1)-[pc3:ckgp1]->(ckgl2)} AND NOT EXISTS {cq: (p1)-[q1]->(v2) where q1.label = c1} '  \
--return 'p1 as id, "qId" as node1, c_label as `node1;label`, p1.label as label, p_label as `label;label`, v1 as node2, v1_label as `node2;label`, concat(p1,"-",c1) as id, p1 as node1, "" as `node1;label`, c1 as label, c1_label as `label;label`, "unknown" as node2, "" as `node2;label` ' \
-o /app/kgtk/data/WD_PoC/qId-p571-K2-unknown.tsv

## K2b => qId, p1365*, ?v1. ?v1, P576, ?v2

\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc \
--match 'cc: (:qId {label: c_label})-[p1:P1365]->(v1 {label: v1_label}), (v1 {label: v1_label})-[p2:P576]->(v2 {label: v2_label})' \
-o /app/kgtk/data/WD_PoC/qId-p1365-p576-K2-base.tsv
...
-o /app/kgtk/data/WD_PoC/qId-p1365-p576-K2path-mandatory-context.tsv

\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc -i $GRAPH_qId_PATH --as p -i $GRAPH_QUALS --as cq -i $GRAPH_CKG_POC --as ckg \
--match 'p: ()-[]->(v1), cc: (v1 {label: v1_label})-[p1:P576 {`label;label`: p1_label}]->(v2 {label: v2_label}), cq: (p1)-[q1]->(v3 {label: v3_label}), ckg: (C {label: C_label})-[pc2:ckgr1]->(c1 {label: c1_label})-[pc1:ckgr2]->(:P576) ' \
--where 'q1.label = c1 AND NOT EXISTS {ckg: (pc1)-[pc3:ckgp1]->(ckgl2)} ' \
--return 'p1 as id, v1 as node1, v1_label as `node1;label`, p1.label as label, p1_label as `label;label`, v2 as node2, v2_label as `node2;label`, q1 as id, p1 as node1, "" as `node1;label`, c1 as label, c1_label as `label;label`, v3 as node2, v3_label as `node2;label`, pc2 as id, C as node1, C_label as `node1;label`, "ckgr1" as label, "ckg:Represented By" as `label;label`, c1 as node2, c1_label as `node2;label`' \
-o /app/kgtk/data/WD_PoC/qId-p1365-p576-K2path-suggested-context.tsv
...
-o /app/kgtk/data/WD_PoC/qId-p1365-p576-K2path-qualified.tsv
...
-o /app/kgtk/data/WD_PoC/qId-p1365-p576-K2path-unknown.tsv

printf "aqui1 "

printf "K3"
# K3. Quais foram as capitais do QId?

\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc \
--match 'cc: (:qId {label: c_label})-[p1:P36]->(v1 {label: v1_label}) ' \
-o /app/kgtk/data/WD_PoC/qId-p36-K3-base.tsv
...
\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc -i $GRAPH_QUALS --as cq -i $GRAPH_CKG_POC --as ckg \
--match 'cc: (:qId {label: c_label})-[p1:P36 {`label;label`: p_label}]->(v1 {label: v1_label}), cq: (p1)-[q1 {`label;label`: q_label}]->(v2 {label: v2_label}), ckg: (C {label: C_label})-[pc2:ckgr1]->(c1 {label: c1_label})-[pc1:ckgr2]->(:P36) ' \
--where 'q1.label = c1 AND EXISTS {ckg: (pc1)-[pc3:ckgp1]->(ckgl2)} ' \
--return 'p1 as id, "qId" as node1, c_label as `node1;label`, p1.label as label, p_label as `label;label`, v1 as node2, v1_label as `node2;label`, q1 as id, p1 as node1, "" as `node1;label`, c1 as label, c1_label as `label;label`, v2 as node2, v2_label as `node2;label`, pc2 as id, C as node1, C_label as `node1;label`, "ckgr1" as label, "ckg:Represented By" as `label;label`, c1 as node2, c1_label as `node2;label`' \
-o /app/kgtk/data/WD_PoC/qId-p36-K3-mandatory-context.tsv

\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc -i $GRAPH_QUALS --as cq -i $GRAPH_CKG_POC --as ckg \
--match 'cc: (:qId {label: c_label})-[p1:P36 {`label;label`: p_label}]->(v1 {label: v1_label}), cq: (p1)-[q1 {`label;label`: q_label}]->(v2 {label: v2_label}), ckg: (C {label: C_label})-[pc2:ckgr1]->(c1 {label: c1_label})-[pc1:ckgr2]->(:P36) ' \
--where 'q1.label = c1 AND NOT EXISTS {ckg: (pc1)-[pc3:ckgp1]->(ckgl2)} ' \
--return 'p1 as id, "qId" as node1, c_label as `node1;label`, p1.label as label, p_label as `label;label`, v1 as node2, v1_label as `node2;label`, q1 as id, p1 as node1, "" as `node1;label`, c1 as label, c1_label as `label;label`, v2 as node2, v2_label as `node2;label`, pc2 as id, C as node1, C_label as `node1;label`, "ckgr1" as label, "ckg:Represented By" as `label;label`, c1 as node2, c1_label as `node2;label`' \
-o /app/kgtk/data/WD_PoC/qId-p36-K3-suggested-context.tsv

\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc -i $GRAPH_QUALS --as cq -i $GRAPH_CKG_POC --as ckg \
--match 'cc: (:qId {label: c_label})-[p1:P36 {`label;label`: p_label}]->(v1 {label: v1_label}) ' \
--optional 'cq: (p1)-[q1 {`label;label`: q_label}]->(v2 {label: v2_label}) ' \
--where 'NOT EXISTS {ckg: (C)-[pc2:ckgr1]->(c1)-[pc1:ckgr2]->(:P36) where q1.label = c1} ' \
--return 'p1 as id, "qId" as node1, c_label as `node1;label`, p1.label as label, p_label as `label;label`, v1 as node2, v1_label as `node2;label`, q1 as id, iif(q1 is not null, p1, "") as node1, "" as `node1;label`, q1.label as label, q_label as `label;label`, v2 as node2, v2_label as `node2;label`' \
-o /app/kgtk/data/WD_PoC/qId-p36-K3-qualified.tsv

\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc -i $GRAPH_QUALS --as cq -i $GRAPH_CKG_POC --as ckg --force \
--match 'cc: (:qId {label: c_label})-[p1:P36 {`label;label`: p_label}]->(v1 {label: v1_label}), ckg: (C {label: C_label})-[pc2:ckgr1]->(c1 {label: c1_label})-[pc1:ckgr2]->(:P36) ' \
--where 'EXISTS {ckg: (pc1)-[pc3:ckgp1]->(ckgl2)} AND NOT EXISTS {cq: (p1)-[q1]->(v2) where q1.label = c1} '  \
--return 'p1 as id, "qId" as node1, c_label as `node1;label`, p1.label as label, p_label as `label;label`, v1 as node2, v1_label as `node2;label`, concat(p1,"-",c1) as id, p1 as node1, "" as `node1;label`, c1 as label, c1_label as `label;label`, "unknown" as node2, "" as `node2;label` ' \
-o /app/kgtk/data/WD_PoC/qId-p36-K3-unknown.tsv
...
--where 'q1.label = c1 AND EXISTS {ckg: (pc1)-[pc3:ckgp1]->(ckgl2)} ' \
--return 'p1 as id, country as node1, c_label as `node1;label`, p1.label as label, p_label as `label;label`, v1 as node2, v1_label as `node2;label`, q1 as id, p1 as node1, "" as `node1;label`, c1 as label, c1_label as `label;label`, v2 as node2, v2_label as `node2;label`, pc2 as id, C as node1, C_label as `node1;label`, "ckgr1" as label, "ckg:Represented By" as `label;label`, c1 as node2, c1_label as `node2;label`' \
-o /app/kgtk/data/WD_PoC/qId-p36-K3path-mandatory-context.tsv

\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc -i $GRAPH_qId_PATH --as p -i $GRAPH_QUALS --as cq -i $GRAPH_CKG_POC --as ckg \
--match 'p: ()-[]->(country), cc: (country {label: c_label})-[p1:P36 {`label;label`: p_label}]->(v1 {label: v1_label}), cq: (p1)-[q1 {`label;label`: q_label}]->(v2 {label: v2_label}), ckg: (C {label: C_label})-[pc2:ckgr1]->(c1 {label: c1_label})-[pc1:ckgr2]->(:P36) ' \
--where 'q1.label = c1 AND NOT EXISTS {ckg: (pc1)-[pc3:ckgp1]->(ckgl2)} ' \
--return 'p1 as id, country as node1, c_label as `node1;label`, p1.label as label, p_label as `label;label`, v1 as node2, v1_label as `node2;label`, q1 as id, p1 as node1, "" as `node1;label`, c1 as label, c1_label as `label;label`, v2 as node2, v2_label as `node2;label`, pc2 as id, C as node1, C_label as `node1;label`, "ckgr1" as label, "ckg:Represented By" as `label;label`, c1 as node2, c1_label as `node2;label`' \
-o /app/kgtk/data/WD_PoC/qId-p36-K3path-suggested-context.tsv
...
--where 'NOT EXISTS {ckg: (C)-[pc2:ckgr1]->(c1)-[pc1:ckgr2]->(:P36) where q1.label = c1} ' \
--return 'p1 as id, country as node1, c_label as `node1;label`, p1.label as label, p_label as `label;label`, v1 as node2, v1_label as `node2;label`, q1 as id, iif(q1 is not null, p1, "") as node1, "" as `node1;label`, q1.label as label, q_label as `label;label`, v2 as node2, v2_label as `node2;label`' \
-o /app/kgtk/data/WD_PoC/qId-p36-K3path-qualified.tsv
...
--return 'p1 as id, country as node1, c_label as `node1;label`, p1.label as label, p_label as `label;label`, v1 as node2, v1_label as `node2;label`, concat(p1,"-",c1) as id, p1 as node1, "" as `node1;label`, c1 as label, c1_label as `label;label`, "unknown" as node2, "" as `node2;label` ' \
-o /app/kgtk/data/WD_PoC/qId-p36-K3path-unknown.tsv

printf "K4"
# K4. Qual é a posição do principal líder administrativo no QId e quem foram estes lideres? 

\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc \
--match 'cc: (:qId {label: c_label})-[p1:P35]->(v1 {label: v1_label}) ' \
-o /app/kgtk/data/WD_PoC/qId-p35-K4-base.tsv

\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc \
--match 'cc: (:qId {label: c_label})-[p2:P1906]->(v2 {label: v2_label})' \
-o /app/kgtk/data/WD_PoC/qId-P1906-K4-base.tsv
...
--where 'q1.label = c1 AND EXISTS {ckg: (pc1)-[pc3:ckgp1]->(ckgl2)} ' \
--return 'p1 as id, "qId" as node1, c_label as `node1;label`, p1.label as label, p_label as `label;label`, v1 as node2, v1_label as `node2;label`, q1 as id, p1 as node1, "" as `node1;label`, c1 as label, c1_label as `label;label`, v2 as node2, v2_label as `node2;label`, pc2 as id, C as node1, C_label as `node1;label`, "ckgr1" as label, "ckg:Represented By" as `label;label`, c1 as node2, c1_label as `node2;label`' \
-o /app/kgtk/data/WD_PoC/qId-p35-K4-mandatory-context.tsv

\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc -i $GRAPH_QUALS --as cq -i $GRAPH_CKG_POC --as ckg \
--match 'cc: (:qId {label: c_label})-[p1:P35 {`label;label`: p_label}]->(v1 {label: v1_label}), cq: (p1)-[q1 {`label;label`: q_label}]->(v2 {label: v2_label}), ckg: (C {label: C_label})-[pc2:ckgr1]->(c1 {label: c1_label})-[pc1:ckgr2]->(:P35) ' \
--where 'q1.label = c1 AND NOT EXISTS {ckg: (pc1)-[pc3:ckgp1]->(ckgl2)} ' \
--return 'p1 as id, "qId" as node1, c_label as `node1;label`, p1.label as label, p_label as `label;label`, v1 as node2, v1_label as `node2;label`, q1 as id, p1 as node1, "" as `node1;label`, c1 as label, c1_label as `label;label`, v2 as node2, v2_label as `node2;label`, pc2 as id, C as node1, C_label as `node1;label`, "ckgr1" as label, "ckg:Represented By" as `label;label`, c1 as node2, c1_label as `node2;label`' \
-o /app/kgtk/data/WD_PoC/qId-p35-K4-suggested-context.tsv

\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc -i $GRAPH_QUALS --as cq -i $GRAPH_CKG_POC --as ckg \
--match 'cc: (:qId {label: c_label})-[p1:P35 {`label;label`: p_label}]->(v1 {label: v1_label}) ' \
--optional 'cq: (p1)-[q1 {`label;label`: q_label}]->(v2 {label: v2_label}) ' \
--where 'NOT EXISTS {ckg: (C)-[pc2:ckgr1]->(c1)-[pc1:ckgr2]->(:P35) where q1.label = c1} ' \
--return 'p1 as id, "qId" as node1, c_label as `node1;label`, p1.label as label, p_label as `label;label`, v1 as node2, v1_label as `node2;label`, q1 as id, iif(q1 is not null, p1, "") as node1, "" as `node1;label`, q1.label as label, q_label as `label;label`, v2 as node2, v2_label as `node2;label`' \
-o /app/kgtk/data/WD_PoC/qId-p35-K4-qualified.tsv

\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc -i $GRAPH_QUALS --as cq -i $GRAPH_CKG_POC --as ckg --force \
--match 'cc: (:qId {label: c_label})-[p1:P35 {`label;label`: p_label}]->(v1 {label: v1_label}), ckg: (C {label: C_label})-[pc2:ckgr1]->(c1 {label: c1_label})-[pc1:ckgr2]->(:P35) ' \
--where 'EXISTS {ckg: (pc1)-[pc3:ckgp1]->(ckgl2)} AND NOT EXISTS {cq: (p1)-[q1]->(v2) where q1.label = c1} '  \
--return 'p1 as id, "qId" as node1, c_label as `node1;label`, p1.label as label, p_label as `label;label`, v1 as node2, v1_label as `node2;label`, concat(p1,"-",c1) as id, p1 as node1, "" as `node1;label`, c1 as label, c1_label as `label;label`, "unknown" as node2, "" as `node2;label` ' \
-o /app/kgtk/data/WD_PoC/qId-p35-K4-unknown.tsv
...
\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc -i $GRAPH_QUALS --as cq -i $GRAPH_CKG_POC --as ckg \
--match 'cc: (:qId {label: c_label})-[p1:P1906 {`label;label`: p_label}]->(v1 {label: v1_label}), cq: (p1)-[q1 {`label;label`: q_label}]->(v2 {label: v2_label}), ckg: (C {label: C_label})-[pc2:ckgr1]->(c1 {label: c1_label})-[pc1:ckgr2]->(:P1906) ' \
--where 'q1.label = c1 AND EXISTS {ckg: (pc1)-[pc3:ckgp1]->(ckgl2)} ' \
--return 'p1 as id, "qId" as node1, c_label as `node1;label`, p1.label as label, p_label as `label;label`, v1 as node2, v1_label as `node2;label`, q1 as id, p1 as node1, "" as `node1;label`, c1 as label, c1_label as `label;label`, v2 as node2, v2_label as `node2;label`, pc2 as id, C as node1, C_label as `node1;label`, "ckgr1" as label, "ckg:Represented By" as `label;label`, c1 as node2, c1_label as `node2;label`' \
-o /app/kgtk/data/WD_PoC/qId-p1906-K4-mandatory-context.tsv

\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc -i $GRAPH_QUALS --as cq -i $GRAPH_CKG_POC --as ckg \
--match 'cc: (:qId {label: c_label})-[p1:P1906 {`label;label`: p_label}]->(v1 {label: v1_label}), cq: (p1)-[q1 {`label;label`: q_label}]->(v2 {label: v2_label}), ckg: (C {label: C_label})-[pc2:ckgr1]->(c1 {label: c1_label})-[pc1:ckgr2]->(:P1906) ' \
--where 'q1.label = c1 AND NOT EXISTS {ckg: (pc1)-[pc3:ckgp1]->(ckgl2)} ' \
--return 'p1 as id, "qId" as node1, c_label as `node1;label`, p1.label as label, p_label as `label;label`, v1 as node2, v1_label as `node2;label`, q1 as id, p1 as node1, "" as `node1;label`, c1 as label, c1_label as `label;label`, v2 as node2, v2_label as `node2;label`, pc2 as id, C as node1, C_label as `node1;label`, "ckgr1" as label, "ckg:Represented By" as `label;label`, c1 as node2, c1_label as `node2;label`' \
-o /app/kgtk/data/WD_PoC/qId-p1906-K4-suggested-context.tsv

\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc -i $GRAPH_QUALS --as cq -i $GRAPH_CKG_POC --as ckg \
--match 'cc: (:qId {label: c_label})-[p1:P1906 {`label;label`: p_label}]->(v1 {label: v1_label}) ' \
--optional 'cq: (p1)-[q1 {`label;label`: q_label}]->(v2 {label: v2_label}) ' \
--where 'NOT EXISTS {ckg: (C)-[pc2:ckgr1]->(c1)-[pc1:ckgr2]->(:P1906) where q1.label = c1} ' \
--return 'p1 as id, "qId" as node1, c_label as `node1;label`, p1.label as label, p_label as `label;label`, v1 as node2, v1_label as `node2;label`, q1 as id, iif(q1 is not null, p1, "") as node1, "" as `node1;label`, q1.label as label, q_label as `label;label`, v2 as node2, v2_label as `node2;label`' \
-o /app/kgtk/data/WD_PoC/qId-p1906-K4-qualified.tsv

\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc -i $GRAPH_QUALS --as cq -i $GRAPH_CKG_POC --as ckg --force \
--match 'cc: (:qId {label: c_label})-[p1:P1906 {`label;label`: p_label}]->(v1 {label: v1_label}), ckg: (C {label: C_label})-[pc2:ckgr1]->(c1 {label: c1_label})-[pc1:ckgr2]->(:P1906) ' \
--where 'EXISTS {ckg: (pc1)-[pc3:ckgp1]->(ckgl2)} AND NOT EXISTS {cq: (p1)-[q1]->(v2) where q1.label = c1} '  \
--return 'p1 as id, "qId" as node1, c_label as `node1;label`, p1.label as label, p_label as `label;label`, v1 as node2, v1_label as `node2;label`, concat(p1,"-",c1) as id, p1 as node1, "" as `node1;label`, c1 as label, c1_label as `label;label`, "unknown" as node2, "" as `node2;label` ' \
-o /app/kgtk/data/WD_PoC/qId-p1906-K4-unknown.tsv
...
\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc -i $GRAPH_QUALS --as cq -i $GRAPH_CKG_POC --as ckg \
--match 'cc: (:qId {label: c_label})-[p1:P6 {`label;label`: p_label}]->(v1 {label: v1_label}), cq: (p1)-[q1 {`label;label`: q_label}]->(v2 {label: v2_label}), ckg: (C {label: C_label})-[pc2:ckgr1]->(c1 {label: c1_label})-[pc1:ckgr2]->(:P6) ' \
--where 'q1.label = c1 AND EXISTS {ckg: (pc1)-[pc3:ckgp1]->(ckgl2)} ' \
--return 'p1 as id, "qId" as node1, c_label as `node1;label`, p1.label as label, p_label as `label;label`, v1 as node2, v1_label as `node2;label`, q1 as id, p1 as node1, "" as `node1;label`, c1 as label, c1_label as `label;label`, v2 as node2, v2_label as `node2;label`, pc2 as id, C as node1, C_label as `node1;label`, "ckgr1" as label, "ckg:Represented By" as `label;label`, c1 as node2, c1_label as `node2;label`' \
-o /app/kgtk/data/WD_PoC/qId-p6-K4-mandatory-context.tsv

\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc -i $GRAPH_QUALS --as cq -i $GRAPH_CKG_POC --as ckg \
--match 'cc: (:qId {label: c_label})-[p1:P6 {`label;label`: p_label}]->(v1 {label: v1_label}), cq: (p1)-[q1 {`label;label`: q_label}]->(v2 {label: v2_label}), ckg: (C {label: C_label})-[pc2:ckgr1]->(c1 {label: c1_label})-[pc1:ckgr2]->(:P6) ' \
--where 'q1.label = c1 AND NOT EXISTS {ckg: (pc1)-[pc3:ckgp1]->(ckgl2)} ' \
--return 'p1 as id, "qId" as node1, c_label as `node1;label`, p1.label as label, p_label as `label;label`, v1 as node2, v1_label as `node2;label`, q1 as id, p1 as node1, "" as `node1;label`, c1 as label, c1_label as `label;label`, v2 as node2, v2_label as `node2;label`, pc2 as id, C as node1, C_label as `node1;label`, "ckgr1" as label, "ckg:Represented By" as `label;label`, c1 as node2, c1_label as `node2;label`' \
-o /app/kgtk/data/WD_PoC/qId-p6-K4-suggested-context.tsv

\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc -i $GRAPH_QUALS --as cq -i $GRAPH_CKG_POC --as ckg \
--match 'cc: (:qId {label: c_label})-[p1:P6 {`label;label`: p_label}]->(v1 {label: v1_label}) ' \
--optional 'cq: (p1)-[q1 {`label;label`: q_label}]->(v2 {label: v2_label}) ' \
--where 'NOT EXISTS {ckg: (C)-[pc2:ckgr1]->(c1)-[pc1:ckgr2]->(:P6) where q1.label = c1} ' \
--return 'p1 as id, "qId" as node1, c_label as `node1;label`, p1.label as label, p_label as `label;label`, v1 as node2, v1_label as `node2;label`, q1 as id, iif(q1 is not null, p1, "") as node1, "" as `node1;label`, q1.label as label, q_label as `label;label`, v2 as node2, v2_label as `node2;label`' \
-o /app/kgtk/data/WD_PoC/qId-p6-K4-qualified.tsv

\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc -i $GRAPH_QUALS --as cq -i $GRAPH_CKG_POC --as ckg --force \
--match 'cc: (:qId {label: c_label})-[p1:P6 {`label;label`: p_label}]->(v1 {label: v1_label}), ckg: (C {label: C_label})-[pc2:ckgr1]->(c1 {label: c1_label})-[pc1:ckgr2]->(:P6) ' \
--where 'EXISTS {ckg: (pc1)-[pc3:ckgp1]->(ckgl2)} AND NOT EXISTS {cq: (p1)-[q1]->(v2) where q1.label = c1} '  \
--return 'p1 as id, "qId" as node1, c_label as `node1;label`, p1.label as label, p_label as `label;label`, v1 as node2, v1_label as `node2;label`, concat(p1,"-",c1) as id, p1 as node1, "" as `node1;label`, c1 as label, c1_label as `label;label`, "unknown" as node2, "" as `node2;label` ' \
-o /app/kgtk/data/WD_PoC/qId-p6-K4-unknown.tsv
...
\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc -i $GRAPH_QUALS --as cq -i $GRAPH_CKG_POC --as ckg \
--match 'cc: (:qId {label: c_label})-[p1:P1313 {`label;label`: p_label}]->(v1 {label: v1_label}), cq: (p1)-[q1 {`label;label`: q_label}]->(v2 {label: v2_label}), ckg: (C {label: C_label})-[pc2:ckgr1]->(c1 {label: c1_label})-[pc1:ckgr2]->(:P1313) ' \
--where 'q1.label = c1 AND EXISTS {ckg: (pc1)-[pc3:ckgp1]->(ckgl2)} ' \
--return 'p1 as id, "qId" as node1, c_label as `node1;label`, p1.label as label, p_label as `label;label`, v1 as node2, v1_label as `node2;label`, q1 as id, p1 as node1, "" as `node1;label`, c1 as label, c1_label as `label;label`, v2 as node2, v2_label as `node2;label`, pc2 as id, C as node1, C_label as `node1;label`, "ckgr1" as label, "ckg:Represented By" as `label;label`, c1 as node2, c1_label as `node2;label`' \
-o /app/kgtk/data/WD_PoC/qId-p1313-K4-mandatory-context.tsv

\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc -i $GRAPH_QUALS --as cq -i $GRAPH_CKG_POC --as ckg \
--match 'cc: (:qId {label: c_label})-[p1:P1313 {`label;label`: p_label}]->(v1 {label: v1_label}), cq: (p1)-[q1 {`label;label`: q_label}]->(v2 {label: v2_label}), ckg: (C {label: C_label})-[pc2:ckgr1]->(c1 {label: c1_label})-[pc1:ckgr2]->(:P1313) ' \
--where 'q1.label = c1 AND NOT EXISTS {ckg: (pc1)-[pc3:ckgp1]->(ckgl2)} ' \
--return 'p1 as id, "qId" as node1, c_label as `node1;label`, p1.label as label, p_label as `label;label`, v1 as node2, v1_label as `node2;label`, q1 as id, p1 as node1, "" as `node1;label`, c1 as label, c1_label as `label;label`, v2 as node2, v2_label as `node2;label`, pc2 as id, C as node1, C_label as `node1;label`, "ckgr1" as label, "ckg:Represented By" as `label;label`, c1 as node2, c1_label as `node2;label`' \
-o /app/kgtk/data/WD_PoC/qId-p1313-K4-suggested-context.tsv

\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc -i $GRAPH_QUALS --as cq -i $GRAPH_CKG_POC --as ckg \
--match 'cc: (:qId {label: c_label})-[p1:P1313 {`label;label`: p_label}]->(v1 {label: v1_label}) ' \
--optional 'cq: (p1)-[q1 {`label;label`: q_label}]->(v2 {label: v2_label}) ' \
--where 'NOT EXISTS {ckg: (C)-[pc2:ckgr1]->(c1)-[pc1:ckgr2]->(:P1313) where q1.label = c1} ' \
--return 'p1 as id, "qId" as node1, c_label as `node1;label`, p1.label as label, p_label as `label;label`, v1 as node2, v1_label as `node2;label`, q1 as id, iif(q1 is not null, p1, "") as node1, "" as `node1;label`, q1.label as label, q_label as `label;label`, v2 as node2, v2_label as `node2;label`' \
-o /app/kgtk/data/WD_PoC/qId-p1313-K4-qualified.tsv

\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc -i $GRAPH_QUALS --as cq -i $GRAPH_CKG_POC --as ckg --force \
--match 'cc: (:qId {label: c_label})-[p1:P1313 {`label;label`: p_label}]->(v1 {label: v1_label}), ckg: (C {label: C_label})-[pc2:ckgr1]->(c1 {label: c1_label})-[pc1:ckgr2]->(:P1313) ' \
--where 'EXISTS {ckg: (pc1)-[pc3:ckgp1]->(ckgl2)} AND NOT EXISTS {cq: (p1)-[q1]->(v2) where q1.label = c1} '  \
--return 'p1 as id, "qId" as node1, c_label as `node1;label`, p1.label as label, p_label as `label;label`, v1 as node2, v1_label as `node2;label`, concat(p1,"-",c1) as id, p1 as node1, "" as `node1;label`, c1 as label, c1_label as `label;label`, "unknown" as node2, "" as `node2;label` ' \
-o /app/kgtk/data/WD_PoC/qId-p1313-K4-unknown.tsv

printf "aqui7 "

printf "K5"
# K5. Qual é o regime de governo no QId? 

\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc \
--match 'cc: (:qId {label: c_label})-[p1:P122]->(v1 {label: v1_label})' \
-o /app/kgtk/data/WD_PoC/qId-p122-K5-base.tsv
...
\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc -i $GRAPH_QUALS --as cq -i $GRAPH_CKG_POC --as ckg \
--match 'cc: (:qId {label: c_label})-[p1:P122 {`label;label`: p_label}]->(v1 {label: v1_label}), cq: (p1)-[q1 {`label;label`: q_label}]->(v2 {label: v2_label}), ckg: (C {label: C_label})-[pc2:ckgr1]->(c1 {label: c1_label})-[pc1:ckgr2]->(:P122) ' \
--where 'q1.label = c1 AND EXISTS {ckg: (pc1)-[pc3:ckgp1]->(ckgl2)} ' \
--return 'p1 as id, "qId" as node1, c_label as `node1;label`, p1.label as label, p_label as `label;label`, v1 as node2, v1_label as `node2;label`, q1 as id, p1 as node1, "" as `node1;label`, c1 as label, c1_label as `label;label`, v2 as node2, v2_label as `node2;label`, pc2 as id, C as node1, C_label as `node1;label`, "ckgr1" as label, "ckg:Represented By" as `label;label`, c1 as node2, c1_label as `node2;label`' \
-o /app/kgtk/data/WD_PoC/qId-p122-K5-mandatory-context.tsv

\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc -i $GRAPH_QUALS --as cq -i $GRAPH_CKG_POC --as ckg \
--match 'cc: (:qId {label: c_label})-[p1:P122 {`label;label`: p_label}]->(v1 {label: v1_label}), cq: (p1)-[q1 {`label;label`: q_label}]->(v2 {label: v2_label}), ckg: (C {label: C_label})-[pc2:ckgr1]->(c1 {label: c1_label})-[pc1:ckgr2]->(:P122) ' \
--where 'q1.label = c1 AND NOT EXISTS {ckg: (pc1)-[pc3:ckgp1]->(ckgl2)} ' \
--return 'p1 as id, "qId" as node1, c_label as `node1;label`, p1.label as label, p_label as `label;label`, v1 as node2, v1_label as `node2;label`, q1 as id, p1 as node1, "" as `node1;label`, c1 as label, c1_label as `label;label`, v2 as node2, v2_label as `node2;label`, pc2 as id, C as node1, C_label as `node1;label`, "ckgr1" as label, "ckg:Represented By" as `label;label`, c1 as node2, c1_label as `node2;label`' \
-o /app/kgtk/data/WD_PoC/qId-p122-K5-suggested-context.tsv

\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc -i $GRAPH_QUALS --as cq -i $GRAPH_CKG_POC --as ckg \
--match 'cc: (:qId {label: c_label})-[p1:P122 {`label;label`: p_label}]->(v1 {label: v1_label}) ' \
--optional 'cq: (p1)-[q1 {`label;label`: q_label}]->(v2 {label: v2_label}) ' \
--where 'NOT EXISTS {ckg: (C)-[pc2:ckgr1]->(c1)-[pc1:ckgr2]->(:P122) where q1.label = c1} ' \
--return 'p1 as id, "qId" as node1, c_label as `node1;label`, p1.label as label, p_label as `label;label`, v1 as node2, v1_label as `node2;label`, q1 as id, iif(q1 is not null, p1, "") as node1, "" as `node1;label`, q1.label as label, q_label as `label;label`, v2 as node2, v2_label as `node2;label`' \
-o /app/kgtk/data/WD_PoC/qId-p122-K5-qualified.tsv

\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc -i $GRAPH_QUALS --as cq -i $GRAPH_CKG_POC --as ckg --force \
--match 'cc: (:qId {label: c_label})-[p1:P122 {`label;label`: p_label}]->(v1 {label: v1_label}), ckg: (C {label: C_label})-[pc2:ckgr1]->(c1 {label: c1_label})-[pc1:ckgr2]->(:P122) ' \
--where 'EXISTS {ckg: (pc1)-[pc3:ckgp1]->(ckgl2)} AND NOT EXISTS {cq: (p1)-[q1]->(v2) where q1.label = c1} '  \
--return 'p1 as id, "qId" as node1, c_label as `node1;label`, p1.label as label, p_label as `label;label`, v1 as node2, v1_label as `node2;label`, concat(p1,"-",c1) as id, p1 as node1, "" as `node1;label`, c1 as label, c1_label as `label;label`, "unknown" as node2, "" as `node2;label` ' \
-o /app/kgtk/data/WD_PoC/qId-p122-K5-unknown.tsv

printf "aqui8 "

#K6. Quais idiomas são falados no QId?

\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc \
--match 'cc: (:qId {label: c_label})-[p1]->(v1 {label: v1_label})' \
--where 'p1.label in ["P2936", "P37", "P103"] ' \
-o /app/kgtk/data/WD_PoC/qId-languages-K6-base.tsv
...
\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc -i $GRAPH_QUALS --as cq -i $GRAPH_CKG_POC --as ckg \
--match 'cc: (:qId {label: c_label})-[p1 {`label;label`: p_label}]->(v1 {label: v1_label}), cq: (p1)-[q1 {`label;label`: q_label}]->(v2 {label: v2_label}), ckg: (C {label: C_label})-[pc2:ckgr1]->(c1 {label: c1_label})-[pc1:ckgr2]->(pred) ' \
--where 'p1.label in ["P2936", "P37", "P103"] AND p1.label = pred AND q1.label = c1 AND EXISTS {ckg: (pc1)-[pc3:ckgp1]->(ckgl2)} ' \
--return 'p1 as id, "qId" as node1, c_label as `node1;label`, p1.label as label, p_label as `label;label`, v1 as node2, v1_label as `node2;label`, q1 as id, p1 as node1, "" as `node1;label`, c1 as label, c1_label as `label;label`, v2 as node2, v2_label as `node2;label`, pc2 as id, C as node1, C_label as `node1;label`, "ckgr1" as label, "ckg:Represented By" as `label;label`, c1 as node2, c1_label as `node2;label`' \
-o /app/kgtk/data/WD_PoC/qId-languages-K6-mandatory-context.tsv

\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc -i $GRAPH_QUALS --as cq -i $GRAPH_CKG_POC --as ckg \
--match 'cc: (:qId {label: c_label})-[p1 {`label;label`: p_label}]->(v1 {label: v1_label}), cq: (p1)-[q1 {`label;label`: q_label}]->(v2 {label: v2_label}), ckg: (C {label: C_label})-[pc2:ckgr1]->(c1 {label: c1_label})-[pc1:ckgr2]->(pred) ' \
--where 'p1.label in ["P2936", "P37", "P103"] AND p1.label = pred AND q1.label = c1 AND NOT EXISTS {ckg: (pc1)-[pc3:ckgp1]->(ckgl2)} ' \
--return 'p1 as id, "qId" as node1, c_label as `node1;label`, p1.label as label, p_label as `label;label`, v1 as node2, v1_label as `node2;label`, q1 as id, p1 as node1, "" as `node1;label`, c1 as label, c1_label as `label;label`, v2 as node2, v2_label as `node2;label`, pc2 as id, C as node1, C_label as `node1;label`, "ckgr1" as label, "ckg:Represented By" as `label;label`, c1 as node2, c1_label as `node2;label`' \
-o /app/kgtk/data/WD_PoC/qId-languages-K6-suggested-context.tsv

\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc -i $GRAPH_QUALS --as cq -i $GRAPH_CKG_POC --as ckg \
--match 'cc: (:qId {label: c_label})-[p1 {`label;label`: p_label}]->(v1 {label: v1_label}) ' \
--where 'p1.label in ["P2936", "P37", "P103"] ' \
--optional 'cq: (p1)-[q1 {`label;label`: q_label}]->(v2 {label: v2_label}) ' \
--where 'NOT EXISTS {ckg: (C)-[pc2:ckgr1]->(c1)-[pc1:ckgr2]->(pred) where q1.label = c1 AND p1.label = pred } ' \
--return 'p1 as id, "qId" as node1, c_label as `node1;label`, p1.label as label, p_label as `label;label`, v1 as node2, v1_label as `node2;label`, q1 as id, iif(q1 is not null, p1, "") as node1, "" as `node1;label`, q1.label as label, q_label as `label;label`, v2 as node2, v2_label as `node2;label`' \
-o /app/kgtk/data/WD_PoC/qId-languages-K6-qualified.tsv

\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc -i $GRAPH_QUALS --as cq -i $GRAPH_CKG_POC --as ckg --force \
--match 'cc: (:qId {label: c_label})-[p1 {`label;label`: p_label}]->(v1 {label: v1_label}), ckg: (C {label: C_label})-[pc2:ckgr1]->(c1 {label: c1_label})-[pc1:ckgr2]->(pred) ' \
--where 'EXISTS {ckg: (pc1)-[pc3:ckgp1]->(ckgl2)} AND NOT EXISTS {cq: (p1)-[q1]->(v2) where q1.label = c1} AND p1.label in ["P2936", "P37", "P103"] ' \
--return 'p1 as id, "qId" as node1, c_label as `node1;label`, p1.label as label, p_label as `label;label`, v1 as node2, v1_label as `node2;label`, concat(p1,"-",c1) as id, p1 as node1, "" as `node1;label`, c1 as label, c1_label as `label;label`, "unknown" as node2, "" as `node2;label` ' \
-o /app/kgtk/data/WD_PoC/qId-languages-K6-unknown.tsv
