...
## K0. Qual é a representação da unidade geo-política atual referente ao "Estados Unidos Mexicanos"? 
## K0 -> ?v1, alias, "United Mexican States". ?v1, P3896, ?v2

\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as c -i $GRAPH_ALIAS --as a \
--match 'c: (v1 {label: c_label})-[p1:P3896]->(v2 {label: v2_label}), a:  (v1)-[]->(v1_alias) ' \
--where 'v1_alias = $name ' --para name="'United Mexican States'@en" \
-o /app/kgtk/data/WD_PoC/Mexico-K0-base.tsv
...
--match 'ckg: (C {label: C_label})-[p2:ckgr1]->(c1 {label: quali_label})-[p1:ckgr2]->(:P3896 {label: pred_label})' \
-o /app/kgtk/data/WD_PoC/CKG-POC-K0-mK-p3896.tsv

\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as c -i $GRAPH_QUALS --as q -i $GRAPH_ALIAS --as a \
--match 'c: (v1 {label: c_label})-[p1:P3896]->(v2 {label: v2_label}), a:  (v1)-[]->(v1_alias), q: (p1)-[q1]->(v2 {label: v2_label}) ' \
--where 'v1_alias = $name ' --para name="'United Mexican States'@en" \
-o /app/kgtk/data/WD_PoC/Mexico-p3896-K0-exact.tsv

\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as c -i $GRAPH_QUALS --as q -i $GRAPH_ALIAS --as a \
--match 'c: (v1 {label: c_label})-[p1:P3896]->(v2 {label: v2_label}), a:  (v1)-[]->(v1_alias) ' \
--where 'v1_alias = $name ' --para name="'United Mexican States'@en" \
--optional 'q: (p1)-[q1]->(v2 {label: v2_label})' \
-o /app/kgtk/data/WD_PoC/Mexico-p3896-K0-possible.tsv
...
export GRAPH_Q96_PATH=/app/kgtk/data/WD_PoC/q96-p1365-K1-path.tsv
...
\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_Q96_PATH --as q96 -i $GRAPH_CLAIMS --as c -i $GRAPH_QUALS --as q \
--match 'q96: (mex)-[]->(v1), c: (country {label: c_label})-[p1:P1365]->(v1 {label: v1_label}), q: (p1)-[q1]->(v2 {label: v2_label})' \
-o /app/kgtk/data/WD_PoC/q96-p1365-K1-path-exact.tsv

\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_Q96_PATH --as q96 -i $GRAPH_CLAIMS --as c -i $GRAPH_QUALS --as q \
--match 'q96: (mex)-[]->(v1), c: (country {label: c_label})-[p1:P1365]->(v1 {label: v1_label}) ' \
--optional 'q: (p1)-[q1]->(v2 {label: v2_label})' \
-o /app/kgtk/data/WD_PoC/q96-p1365-K1-path-possible.tsv

## K1 => ?v1, p1366, q96

\time --format='Elapsed time: %e seconds'  kgtk --debug reachable-nodes -i $GRAPH_CLAIMS --root Q96 --prop P1366 --inverted --breadth-first \
-o /app/kgtk/data/WD_PoC/q96-p1366-K1-path.tsv
...
\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_Q96_PATH --as q96 -i $GRAPH_CLAIMS --as c -i $GRAPH_QUALS --as q \
--match 'q96: (mex)-[]->(v1), c: (v1 {label: v1_label})-[p1:P36]->(v2 {label: v2_label}), q: (p1)-[q1]->(v3 {label: v3_label})' \
-o /app/kgtk/data/WD_PoC/q96-p36-K3-path-exact.tsv

\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_Q96_PATH --as q96 -i $GRAPH_CLAIMS --as c -i $GRAPH_QUALS --as q \
--match 'q96: (mex)-[]->(v1), c: (v1 {label: v1_label})-[p1:P36]->(v2 {label: v2_label}) ' \
--optional 'q: (p1)-[q1]->(v3 {label: v3_label})' \
-o /app/kgtk/data/WD_PoC/q96-p36-K3-path-possible.tsv
