...
-o /app/kgtk/data/WD_PoC/q155-p1365-K1-base.tsv
...
-o /app/kgtk/data/WD_PoC/q155-p1365-K1-qualified.tsv
...
-o /app/kgtk/data/WD_PoC/q155-p1366-K1-base.tsv
...
\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc -i $GRAPH_QUALS --as cq -i $GRAPH_CKG_POC --as ckg \
--match 'cc: (:Q155 {label: c_label})-[p1:P1366 {`label;label`: p_label}]->(v1 {label: v1_label}) ' \
--optional 'cq: (p1)-[q1 {`label;label`: q_label}]->(v2 {label: v2_label}) ' \
--where 'NOT EXISTS {ckg: (C)-[pc2:ckgr1]->(c1)-[pc1:ckgr2]->(:P1366) where q1.label = c1} ' \
--return 'p1 as id, "Q155" as node1, c_label as `node1;label`, p1.label as label, p_label as `label;label`, v1 as node2, v1_label as `node2;label`, q1 as id, iif(q1 is not null, p1, "") as node1, "" as `node1;label`, q1.label as label, q_label as `label;label`, v2 as node2, v2_label as `node2;label`' \
-o /app/kgtk/data/WD_PoC/q155-p1366-K1-qualified.tsv
...
\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc \
--match 'cc: (:Q155 {label: c_label})-[p1:P571]->(v1 {label: v1_label}) ' \
-o /app/kgtk/data/WD_PoC/q155-p571-K2-base.tsv
...
\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc -i $GRAPH_QUALS --as cq -i $GRAPH_CKG_POC --as ckg \
--match 'cc: (:Q155 {label: c_label})-[p1:P571 {`label;label`: p_label}]->(v1 {label: v1_label}) ' \
--optional 'cq: (p1)-[q1 {`label;label`: q_label}]->(v2 {label: v2_label}) ' \
--where 'NOT EXISTS {ckg: (C)-[pc2:ckgr1]->(c1)-[pc1:ckgr2]->(:P571) where q1.label = c1} ' \
--return 'p1 as id, "Q155" as node1, c_label as `node1;label`, p1.label as label, p_label as `label;label`, v1 as node2, v1_label as `node2;label`, q1 as id, iif(q1 is not null, p1, "") as node1, "" as `node1;label`, q1.label as label, q_label as `label;label`, v2 as node2, v2_label as `node2;label`' \
-o /app/kgtk/data/WD_PoC/q155-p571-K2-qualified.tsv
...
\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc \
--match 'cc: (:Q155 {label: c_label})-[p1:P1365]->(v1 {label: v1_label}), (v1 {label: v1_label})-[p2:P576]->(v2 {label: v2_label})' \
-o /app/kgtk/data/WD_PoC/q155-p1365-p576-K2-base.tsv
...
\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc -i $GRAPH_Q155_PATH --as p -i $GRAPH_QUALS --as cq -i $GRAPH_CKG_POC --as ckg \
--match 'p: ()-[]->(v1), cc: (v1 {label: v1_label})-[p1:P576 {label: p1_label}]->(v2 {label: v2_label}) ' \
--optional 'cq: (p1)-[q1 {`label;label`: q_label}]->(v3 {label: v3_label}) ' \
...
-o /app/kgtk/data/WD_PoC/q155-p1365-p576-K2path-qualified.tsv
...
printf "K3"
# K3. Quais foram as capitais do Brasil?

\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc \
--match 'cc: (:Q155 {label: c_label})-[p1:P36]->(v1 {label: v1_label}) ' \
-o /app/kgtk/data/WD_PoC/q155-p36-K3-base.tsv
...
\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc -i $GRAPH_QUALS --as cq -i $GRAPH_CKG_POC --as ckg \
--match 'cc: (:Q155 {label: c_label})-[p1:P36 {`label;label`: p_label}]->(v1 {label: v1_label}) ' \
--optional 'cq: (p1)-[q1 {`label;label`: q_label}]->(v2 {label: v2_label}) ' \
--where 'NOT EXISTS {ckg: (C)-[pc2:ckgr1]->(c1)-[pc1:ckgr2]->(:P36) where q1.label = c1} ' \
--return 'p1 as id, "Q155" as node1, c_label as `node1;label`, p1.label as label, p_label as `label;label`, v1 as node2, v1_label as `node2;label`, q1 as id, iif(q1 is not null, p1, "") as node1, "" as `node1;label`, q1.label as label, q_label as `label;label`, v2 as node2, v2_label as `node2;label`' \
-o /app/kgtk/data/WD_PoC/q155-p36-K3-qualified.tsv
...
--where 'NOT EXISTS {ckg: (C)-[pc2:ckgr1]->(c1)-[pc1:ckgr2]->(:P36) where q1.label = c1} ' \
--return 'p1 as id, country as node1, c_label as `node1;label`, p1.label as label, p_label as `label;label`, v1 as node2, v1_label as `node2;label`, q1 as id, iif(q1 is not null, p1, "") as node1, "" as `node1;label`, q1.label as label, q_label as `label;label`, v2 as node2, v2_label as `node2;label`' \
-o /app/kgtk/data/WD_PoC/q155-p36-K3path-qualified.tsv
...
\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc \
--match 'cc: (:Q155 {label: c_label})-[p1:P35]->(v1 {label: v1_label}) ' \
-o /app/kgtk/data/WD_PoC/q155-p35-K4-base.tsv

\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc \
--match 'cc: (:Q155 {label: c_label})-[p2:P1906]->(v2 {label: v2_label})' \
-o /app/kgtk/data/WD_PoC/q155-P1906-K4-base.tsv
...
\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc -i $GRAPH_QUALS --as cq -i $GRAPH_CKG_POC --as ckg \
--match 'cc: (:Q155 {label: c_label})-[p1:P35 {`label;label`: p_label}]->(v1 {label: v1_label}) ' \
--optional 'cq: (p1)-[q1 {`label;label`: q_label}]->(v2 {label: v2_label}) ' \
--where 'NOT EXISTS {ckg: (C)-[pc2:ckgr1]->(c1)-[pc1:ckgr2]->(:P35) where q1.label = c1} ' \
--return 'p1 as id, "Q155" as node1, c_label as `node1;label`, p1.label as label, p_label as `label;label`, v1 as node2, v1_label as `node2;label`, q1 as id, iif(q1 is not null, p1, "") as node1, "" as `node1;label`, q1.label as label, q_label as `label;label`, v2 as node2, v2_label as `node2;label`' \
-o /app/kgtk/data/WD_PoC/q155-p35-K4-qualified.tsv
...
\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc -i $GRAPH_QUALS --as cq -i $GRAPH_CKG_POC --as ckg \
--match 'cc: (:Q155 {label: c_label})-[p1:P1906 {`label;label`: p_label}]->(v1 {label: v1_label}) ' \
--optional 'cq: (p1)-[q1 {`label;label`: q_label}]->(v2 {label: v2_label}) ' \
--where 'NOT EXISTS {ckg: (C)-[pc2:ckgr1]->(c1)-[pc1:ckgr2]->(:P1906) where q1.label = c1} ' \
--return 'p1 as id, "Q155" as node1, c_label as `node1;label`, p1.label as label, p_label as `label;label`, v1 as node2, v1_label as `node2;label`, q1 as id, iif(q1 is not null, p1, "") as node1, "" as `node1;label`, q1.label as label, q_label as `label;label`, v2 as node2, v2_label as `node2;label`' \
-o /app/kgtk/data/WD_PoC/q155-p1906-K4-qualified.tsv
...
\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc -i $GRAPH_QUALS --as cq -i $GRAPH_CKG_POC --as ckg \
--match 'cc: (:Q155 {label: c_label})-[p1:P6 {`label;label`: p_label}]->(v1 {label: v1_label}) ' \
--optional 'cq: (p1)-[q1 {`label;label`: q_label}]->(v2 {label: v2_label}) ' \
--where 'NOT EXISTS {ckg: (C)-[pc2:ckgr1]->(c1)-[pc1:ckgr2]->(:P6) where q1.label = c1} ' \
--return 'p1 as id, "Q155" as node1, c_label as `node1;label`, p1.label as label, p_label as `label;label`, v1 as node2, v1_label as `node2;label`, q1 as id, iif(q1 is not null, p1, "") as node1, "" as `node1;label`, q1.label as label, q_label as `label;label`, v2 as node2, v2_label as `node2;label`' \
-o /app/kgtk/data/WD_PoC/q155-p6-K4-qualified.tsv
...
\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc -i $GRAPH_QUALS --as cq -i $GRAPH_CKG_POC --as ckg \
--match 'cc: (:Q155 {label: c_label})-[p1:P1313 {`label;label`: p_label}]->(v1 {label: v1_label}) ' \
--optional 'cq: (p1)-[q1 {`label;label`: q_label}]->(v2 {label: v2_label}) ' \
--where 'NOT EXISTS {ckg: (C)-[pc2:ckgr1]->(c1)-[pc1:ckgr2]->(:P1313) where q1.label = c1} ' \
--return 'p1 as id, "Q155" as node1, c_label as `node1;label`, p1.label as label, p_label as `label;label`, v1 as node2, v1_label as `node2;label`, q1 as id, iif(q1 is not null, p1, "") as node1, "" as `node1;label`, q1.label as label, q_label as `label;label`, v2 as node2, v2_label as `node2;label`' \
-o /app/kgtk/data/WD_PoC/q155-p1313-K4-qualified.tsv
...
printf "K5"
# K5. Qual é o regime de governo no Brasil? 

\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc \
--match 'cc: (:Q155 {label: c_label})-[p1:P122]->(v1 {label: v1_label})' \
-o /app/kgtk/data/WD_PoC/q155-p122-K5-base.tsv
...
\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc -i $GRAPH_QUALS --as cq -i $GRAPH_CKG_POC --as ckg \
--match 'cc: (:Q155 {label: c_label})-[p1:P122 {`label;label`: p_label}]->(v1 {label: v1_label}) ' \
--optional 'cq: (p1)-[q1 {`label;label`: q_label}]->(v2 {label: v2_label}) ' \
--where 'NOT EXISTS {ckg: (C)-[pc2:ckgr1]->(c1)-[pc1:ckgr2]->(:P122) where q1.label = c1} ' \
--return 'p1 as id, "Q155" as node1, c_label as `node1;label`, p1.label as label, p_label as `label;label`, v1 as node2, v1_label as `node2;label`, q1 as id, iif(q1 is not null, p1, "") as node1, "" as `node1;label`, q1.label as label, q_label as `label;label`, v2 as node2, v2_label as `node2;label`' \
-o /app/kgtk/data/WD_PoC/q155-p122-K5-qualified.tsv
...
#K6. Quais idiomas são falados no Brasil?

\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc \
--match 'cc: (:Q155 {label: c_label})-[p1]->(v1 {label: v1_label})' \
--where 'p1.label in ["P2936", "P37", "P103"] ' \
-o /app/kgtk/data/WD_PoC/q155-languages-K6-base.tsv
...
\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc -i $GRAPH_QUALS --as cq -i $GRAPH_CKG_POC --as ckg \
--match 'cc: (:Q155 {label: c_label})-[p1 {`label;label`: p_label}]->(v1 {label: v1_label}) ' \
--where 'p1.label in ["P2936", "P37", "P103"] ' \
--optional 'cq: (p1)-[q1 {`label;label`: q_label}]->(v2 {label: v2_label}) ' \
--where 'NOT EXISTS {ckg: (C)-[pc2:ckgr1]->(c1)-[pc1:ckgr2]->(pred) where q1.label = c1 AND p1.label = pred } ' \
--return 'p1 as id, "Q155" as node1, c_label as `node1;label`, p1.label as label, p_label as `label;label`, v1 as node2, v1_label as `node2;label`, q1 as id, iif(q1 is not null, p1, "") as node1, "" as `node1;label`, q1.label as label, q_label as `label;label`, v2 as node2, v2_label as `node2;label`' \
-o /app/kgtk/data/WD_PoC/q155-languages-K6-qualified.tsv

\time --format='Elapsed time: %e seconds'  kgtk --debug query -i $GRAPH_CLAIMS --as cc -i $GRAPH_QUALS --as cq -i $GRAPH_CKG_POC --as ckg --force \
--match 'cc: (:Q155 {label: c_label})-[p1 {label: pred_label}]->(v1 {label: v1_label}), ckg: (C {label: C_label})-[pc2:ckgr1]->(c1 {label: c1_label})-[pc1:ckgr2]->(pred) ' \
--where 'EXISTS {ckg: (pc1)-[pc3:ckgp1]->(ckgl2)} AND NOT EXISTS {cq: (p1)-[q1]->(v2) where q1.label = c1} AND p1.label in ["P2936", "P37", "P103"] ' \
--return 'p1 as id, "Q155" as node1, c_label as `node1;label`, p1.label as label, pred_label as `label;label`, v1 as node2, v1_label as `node2;label`, concat(p1,"-",c1) as id, p1 as node1, "" as `node1;label`, c1 as label, c1_label as `label;label`, "unknown" as node2, "" as `node2;label` ' \
